...
author: 'Nimixx'
heroImage: '../../assets/react_boilerplate.jpg'
imageCredit: 'https://unsplash.com/@codioful?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText'
imageAuthor: 'Codioful'
